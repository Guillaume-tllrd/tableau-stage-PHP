...
$sql = "INSERT INTO stage (statut_de_la_recherche, nom_de_lentreprise, date_denvoi, date_de_relance, type_de_postulation, methode_de_postulation, intitule_du_poste, type_de_contrat, email, commentaires) VALUES (:statut_de_la_recherche, :nom_de_lentreprise, :date_denvoi, :date_de_relance, :type_de_postulation, :methode_de_postulation, :intitule_du_poste, :type_de_contrat, :email, :commentaires)";
