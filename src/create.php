...
$nom_entreprise= strip_tags($_POST["nom_de_lentreprise"]); 
...
$intitulé_du_poste = strip_tags($_POST["intitulé_du_poste"]);
$type_de_contrat = strip_tags($_POST["type_de_contrat"]);
$email = strip_tags($_POST["email"]);
$commentaires = strip_tags($_POST["commentaires"]);

$sql = "INSERT INTO stage (statut_de_la_recherche, nom_de_lentreprise, date_denvoi, date_de_relance,type_de_postulation, methode_de_postulation, 	intitulé_du_poste, type_de_contrat, email, commentaires) VALUES (:statut_de_la_recherche, :nom_de_lentreprise, :date_denvoi, :date_de_relance,:type_de_postulation, :methode_de_postulation, :intitulé_du_poste, :type_de_contrat, :email, :commentaires)";

$query = $db->prepare($sql);
$query->bindValue(":statut_de_la_recherche", $statut_de_la_recherche);
$query->bindValue(":nom_de_l'entreprise", $nom_de_lentreprise);
...
$query->bindValue(":intitulé_du_poste", $intitulé_du_poste);
